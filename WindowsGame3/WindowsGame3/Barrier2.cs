...
{
    public class Barrier2 //Класс препятствия
    {
        //Переменные
        ...
        public Barrier2(Texture2D newTexture, Vector2 newPosition) //Конструткор
        {
        ...
        {
            boundingBox = new Rectangle((int)position.X, (int)position.Y, 40, 36); //Обновление координат позиции препятствия
